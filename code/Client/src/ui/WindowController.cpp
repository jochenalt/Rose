...
void WindowController::setBodyPose(const TotalBodyPose& pose) {
	...
	createTransformationMatrix(pose.head, bodyTransformation);
	...
	mainBotView.setBodyPose(pose, lookAtCoordFromBodysPerspective);
}
