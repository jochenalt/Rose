...
void MicrophoneInput::setup(int samplerate) {
	...
	cout << "using alsa default device for audio microphone input with " << MicrophoneSampleRate << "Hz and latency of " << (int)(getMicrophoneLatency()*1000.0) << "ms" << endl;
}
